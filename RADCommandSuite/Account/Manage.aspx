<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/VideoUp.master" AutoEventWireup="true" CodeFile="Manage.aspx.cs" Inherits="Account_Manage" %>
            ...
            <section id="passwordForm">
                ...
                <asp:PlaceHolder runat="server" ID="changePasswordHolder" Visible="false">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-10">
                                <asp:Button ID="Button2" runat="server" Text="Change password" OnClick="ChangePassword_Click" 
                                    class="btn btn-primary btn-large" ValidationGroup="ChangePassword" />
                            </div>
                        </div>
                    </div>
                </asp:PlaceHolder>
