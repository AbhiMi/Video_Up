<%@ Page Title="Register" Language="C#" MasterPageFile="~/VideoUp.master" AutoEventWireup="true" CodeFile="Register.aspx.cs" Inherits="Account_Register" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="SelectCompany" CssClass="col-md-2 control-label">Select Company</asp:Label>
            <div class="col-md-10">
