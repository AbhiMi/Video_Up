<%@ Page Title="" Language="C#" MasterPageFile="~/VideoUp.master" AutoEventWireup="true" CodeFile="PlayListCampaignAssociation.aspx.cs" Inherits="AssociationViews_PlayListCampaignAssociation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <div style="border: 2px solid #a1a1a1; padding: 10px 40px; background: #dddddd; border-radius: 25px;">
        <div style="border: 1px solid rgba(80, 124, 208, 1); background: rgba(80, 124, 208, 1); border-radius: 5px; color: white; padding-left: 5px; text-align: center">
            <h4>Associate PlayList to Campaigns</h4>
        </div>
                ...
                <tr>
                    <td style="padding-right: 100px;">
                        <div style="background: rgba(80, 124, 208, 1); border-radius: 10px; color: white; padding-left: 5px; margin-bottom: 10px; width: 500px; text-align: center">
                            <h4>Please select PlayList for Association</h4>
                        </div>
                        <div style="background-color: #507CD1; background-repeat: repeat-x; height: 30px; width: 500px; margin: 0; padding: 0">
                            <table cellspacing="0" cellpadding="0" rules="all" border="1" id="tblPlayListHeader"
                                ...
                                <tr>
                                    ...
                                    <td style="width: 100px; text-align: center">PlayList ID</td>
                                    <td style="width: 250px; text-align: center">PlayList Name</td>
                                </tr>
                            </table>
                        </div>
                        <div style="float: left; height: 200px; width: 500px; overflow: auto;">
                            <asp:GridView ID="grdPlayList" runat="server" AutoGenerateColumns="false" CellPadding="4"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center" DataField="PlayListID" HeaderText="ID"></asp:BoundField>
                                    <asp:BoundField ItemStyle-Width="250px" ItemStyle-HorizontalAlign="Center" DataField="PlayListName" HeaderText="PlayList Name"></asp:BoundField>
                                </Columns>
                    ...
                    <td>
                        <div style="background: rgba(80, 124, 208, 1); border-radius: 10px; color: white; padding-left: 5px; margin-bottom: 10px; width: 500px; text-align: center">
                            <h4>Please select Campaign to associate to PlayList</h4>
                        </div>
                        <div style="background-color: #507CD1; background-repeat: repeat-x; height: 30px; width: 500px; margin: 0; padding: 0">
                            <table cellspacing="0" cellpadding="0" rules="all" border="1" id="tblPlaylistHeader"
                                style="font-family: Arial; font-size: 10pt; width: 500px; color: white; border-collapse: collapse; height: 100%;">
                        ...
                        <div style="float: right; height: 200px; width: 500px; overflow: auto;">
                            <asp:GridView ID="grdCampaign" runat="server" Style="height: 100px; overflow: auto" AutoGenerateColumns="false"
                                CellPadding="4" ForeColor="#333333" GridLines="Horizontal" ShowHeader="false">
                                <Columns>
                                    <asp:TemplateField ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center" HeaderText="Select">
                                        <ItemTemplate>
                                            <asp:CheckBox ID="cbSelectCampaign" runat="server"></asp:CheckBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center" DataField="CampaignID" HeaderText="ID"></asp:BoundField>
                                    <asp:BoundField ItemStyle-Width="350px" ItemStyle-HorizontalAlign="Center" DataField="CampaignName" HeaderText="Campaign Name"></asp:BoundField>
                                </Columns>
                                <AlternatingRowStyle BackColor="White" />
                                <EditRowStyle BackColor="#2461BF" />
                                <FooterStyle BackColor="#507CD1" ForeColor="White" Font-Bold="True" />
                    ...
                    <td>
                        <div style="float: right; margin-left: 30px">
                            <asp:Button runat="server" ID="btnAssociatePlayList" Text="Associate PlayList to Campaign" class="btn btn-primary btn-large" OnClick="btnAssociatePlayList_Click" />
                        </div>
                    </td>
                </tr>
            </table>
        ...
        <div align="center" style="border: 2px solid #a1a1a1; padding: 10px 40px; background: #dddddd; border-radius: 25px; margin-bottom: 20px">
            <div style="background: rgba(80, 124, 208, 1); border-radius: 10px; color: white; padding-left: 5px; margin-bottom: 10px; width: 500px; text-align: center">
                <h4>Playlist and Campaign Association</h4>
            </div>
            <div style="background-color: #507CD1; background-repeat: repeat-x; height: 30px; width: 500px; margin: 0; padding: 0">
            ...
            <div style="height: 200px; width: 500px; overflow: auto;">
                <asp:GridView ID="grdPlayListCampaign" runat="server" CellPadding="4" ForeColor="#333333" GridLines="Horizontal" ShowHeader="false" AutoGenerateColumns="false">
                    <Columns>
                        <asp:BoundField ItemStyle-Width="250px" ItemStyle-HorizontalAlign="Center" DataField="PlayListName" HeaderText="PlayList Name"></asp:BoundField>
                        <asp:BoundField ItemStyle-Width="250px" ItemStyle-HorizontalAlign="Center" DataField="CampaignName" HeaderText="Campaign Name"></asp:BoundField>
                    </Columns>
                    <AlternatingRowStyle BackColor="White" />
                    <EditRowStyle BackColor="#2461BF" />
                    <FooterStyle BackColor="#507CD1" ForeColor="White" Font-Bold="True" />
