<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddNewArea.aspx.cs" Inherits="Pages_AddNewArea" %>
            ...
            <table id="tblRegion" runat="server">
                <tr>
                    <td style="padding-right: 20px; padding-top: 2px;">
                        <asp:Label ID="lblCreateArea" Text="Area Name:" runat="server" CssClass="label" />
                    </td>
                    <td>
                 ...
                 <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlRegions" DataTextField="RegionName" DataValueField="RegionID" runat="server" Width="250px" />
                    </td>
                </tr>
                <tr>
                    <td></td>
                    <td style="float: left; margin-top: 10px">
                        <asp:Button ID="btnCreateArea" runat="server" Text="Create Area" CssClass="button" OnClick="btnCreateArea_Click" />
                    </td>
                </tr>
                <tr>
                    <td>
