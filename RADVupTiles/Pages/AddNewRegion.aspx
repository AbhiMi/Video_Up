<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddNewRegion.aspx.cs" Inherits="Pages_AddNewRegion" %>
            ...
            <table id="tblRegion" runat="server">
                <tr>
                    <td style="padding-right: 20px; padding-top: 2px;">
                        <asp:Label ID="lblCreateRegion" Text="Region Name:" runat="server" CssClass="label" />
                    </td>
                    <td>
                        <asp:TextBox ID="txtCreateRegion" runat="server" />
                    </td>
                </tr>
                 <tr>
                    <td style="padding-right: 20px; padding-top: 2px;">
                    ...
                    <td>
                        <asp:TextBox ID="txtDescription" TextMode="MultiLine" Width="250px" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td></td>
                    <td style="float: left; margin-top: 10px">
                        <asp:Button ID="btnCreateRegion" runat="server" Text="Create Region" CssClass="button" OnClick="btnCreateRegion_Click" />
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Label ID="lblCreateRegionStatus" runat="server" Visible="false" Font-Bold="true" />
                    </td>
                </tr>
            </table>
        </div>
