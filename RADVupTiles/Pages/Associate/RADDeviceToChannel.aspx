<%@ Page Title="" Language="C#" MasterPageFile="~/RADVupTiles.master" AutoEventWireup="true" CodeFile="RADDeviceToChannel.aspx.cs" Inherits="Pages_Associate_RADDeviceToChannel" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#<%=txtRADDevice.ClientID%>").autocomplete('Search_RADDevice.ashx');
        });
    </script>
    <script type="text/javascript">
        $(function () {
            $(".drag_drop_grid").sortable({
                ...
                receive: function (e, ui) {
                    ...
                    channel.ID = $("[id*=gvDest] tr:last").find("td:nth-child(1)").html();
                    channel.RADDeviceID = $("#<%=hdnRADDeviceID.ClientID%>").val()
                    $.ajax({
                        type: "POST",
                        url: "RADDeviceToChannel.aspx/SaveCampaign",
    ...
    <script type="text/javascript">
        ...
        function ConfirmUnAssociate() {
            return confirm("Are you sure you would like to unassociate this Channel?");
        }
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
     ...
     <div style="padding: 10px; border-radius: 10px; background: transparent url(../img/wallpapers/Brushed-Metal.jpg); position: relative; background-repeat: repeat; width: 95%; margin-top: 25px">
        <div style="float: right; border: 3px solid Gray; min-height: 425px; padding: 10px; 
                border-radius: 10px; width: 22%;float:left;margin:50px 0 0 -25px">
            ...
            <asp:HiddenField ID="hdnRADDeviceID" runat="server" />
                ...
                <asp:GridView ID="grdRADDevice" runat="server" AutoGenerateColumns="false" ClientIDMode="Static" ShowHeaderWhenEmpty="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="RADDevice Name" ControlStyle-Width="180px" HeaderStyle-HorizontalAlign="Left" SortExpression="DeviceInfo">
                            <ItemTemplate>
                                <asp:HyperLink runat="server" NavigateUrl='<%# string.Format("~/Pages/Associate/RADDeviceToChannel.aspx?RADDeviceName={0}",
                    HttpUtility.UrlEncode(Eval("DeviceInfo").ToString())) %>'
         ...
         <div id="dragdrop" runat="server" style="width: 52%; float: right;margin-top:50px">
            <div style="float: left; width: 45%; border: 3px solid Gray; min-height: 425px; border-radius: 10px; padding: 10px;">
                <h3 class="h3" style="width: 190px; background-color: rgba(209, 209, 209, 1)">Associated Channel</h3>
                ...
                <div class="content scrollbar" style="height: 350px">
                    <asp:GridView ID="gvDest" GridLines="None" runat="server" ShowHeaderWhenEmpty="true" CssClass="drag_drop_grid Grid" AutoGenerateColumns="false"
                        DataKeyNames="ChannelName,ChannelID" AlternatingRowStyle-CssClass="alt" PagerStyle-CssClass="pgr" AllowSorting="true" OnSorting="gvDest_Sorting">
                        <Columns>
                            <asp:BoundField DataField="ChannelID" Visible="false"></asp:BoundField>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    ...
                                    <asp:Panel ID="pnlChannel" runat="server" Visible="false" Style="position: relative">
                                        <asp:GridView ID="gvChannel" runat="server" AutoGenerateColumns="false" PageSize="5" Width="250px"
                                            AllowPaging="true" CssClass="Grid marginLeft20" AlternatingRowStyle-CssClass="alt" PagerStyle-CssClass="pgr">
                                            <Columns>
                            ...
                            <asp:HyperLinkField runat="server" ItemStyle-Width="150px" DataTextField="ChannelName" HeaderText="Associated Channels"
                                  DataNavigateUrlFormatString="CampaignToChannel.aspx?ChannelName={0}" DataNavigateUrlFields="ChannelName" SortExpression="ChannelName" />
                           <%-- <asp:BoundField ItemStyle-Width="150px" ItemStyle-HorizontalAlign="Left" DataField="ChannelName"
                                HeaderText="Associated Channels" HeaderStyle-HorizontalAlign="Left" SortExpression="ChannelName"></asp:BoundField>--%>
                            <asp:TemplateField>
                                <ItemTemplate>
             ...
             <div style="float: right; width: 46%; border: 3px solid gray; min-height: 425px; border-radius: 10px; padding: 10px;">
                <h3 class="h3" style="width: 175px; background-color: rgba(206, 206, 204, 1)">Available Channel</h3>
                <asp:Label ID="lblNote" runat="server" Text="* Please select a channel and <br/> drag & drop to assign campaigns." CssClass="label" />
                <div class="content scrollbar" style="height: 350px">
                    <asp:GridView ID="gvSource" GridLines="None" runat="server" CssClass="drag_drop_grid Grid" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            <asp:BoundField ItemStyle-Width="25px" ItemStyle-Height="20px" ItemStyle-HorizontalAlign="Center" DataField="ChannelID"
                                HeaderText="ID" SortExpression="ChannelID"></asp:BoundField>
                            <asp:TemplateField HeaderText="" ItemStyle-Width="30px" ItemStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                    <asp:Image ID="imgThumbNail" runat="server" ImageUrl='<%# "~/img/" + Eval("FileName") %>' CssClass="thumbNailImage" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField ItemStyle-Width="300px" ItemStyle-HorizontalAlign="Left" DataField="ChannelName"
                                HeaderText="Available Channels" HeaderStyle-HorizontalAlign="Left" SortExpression="ChannelName"></asp:BoundField>
                        </Columns>
                    </asp:GridView>
                </div>
            </div>
