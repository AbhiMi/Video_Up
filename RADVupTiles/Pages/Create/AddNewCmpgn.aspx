<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddNewCmpgn.aspx.cs" Inherits="Pages_Create_AddNewCmpgn" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <table id="tblCampaign" runat="server" style="margin: 20px">
                ...
                <tr>
                    <td style="padding-right: 20px; padding-top: 2px;">
                        <asp:Label ID="Label1" runat="server" Text="Campaign Color:" CssClass="label" />
                    </td>
                    <td>
