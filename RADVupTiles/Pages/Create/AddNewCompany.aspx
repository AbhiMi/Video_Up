<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddNewCompany.aspx.cs" Inherits="Pages_AddNewCompany" %>
            ...
            <table id="tblCompany" runat="server">
                <tr>
                    <td style="padding-right: 20px; padding-top: 2px;">
                        <asp:Label ID="lblCreateCompany" Text="Company Name:" runat="server" CssClass="label" />
                    </td>
                    <td>
                 ...
                 <tr>
                    <td style="padding-right: 20px; padding-top: 2px;">
                        <asp:Label ID="lblCompanyCode" Text="Company Code:" runat="server" CssClass="label" />
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td style="float: left; margin-top: 10px">
                        <asp:Button ID="btnCreateCompany" runat="server" Text="Create Company" CssClass="button" OnClick="btnCreateCompany_Click" />
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Label ID="lblCreateCompanyStatus" runat="server" Visible="false" Font-Bold="true" />
                    </td>
                </tr>
            </table>
        </div>
