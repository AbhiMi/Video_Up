<%@ Page Title="" Language="C#" MasterPageFile="~/RADVupTiles.master" AutoEventWireup="true" CodeFile="CreateCampaign.aspx.cs" Inherits="Pages_CreateCampaign" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function ShowSearchData() {
            // alert($("#<%=txtSearch.ClientID%>")[0].value);
            $.ajax({
                type: "POST",
                url: "CreateCampaign.aspx/SearchText",
        ...
        function ShowText(myFile) {
            ...
            <%--var fileUpload = document.getElementById('<% = imgFileUpload.ClientID %>');--%>
            myFile.action = myFile.action + "?FilePath=" + fileUpload.value;
            // alert(filename);
            ...
            $(".drag_drop_grid").sortable({
                ...
                receive: function (e, ui) {
                   ...
                   <%-- var gvid = '<%=gvDest.ClientID %>';--%>
                    ...
                    $.ajax({
                        type: "POST",
                        url: "CreateCampaign.aspx/SavePlayList",
    ...
    <script>
        ...
        $(function () { SetupFilter("txtCampaign", "grdCampaign", "Campaign Name"); });
    </script>
    <script type="text/javascript">
        $(function () {
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            function AddNewCampaign() {
                window.radopen("AddNewCmpgn.aspx", "RadCampaignDialog");
                return false;
            }
        </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    ...
    <div style="width: 95%">
        <div style="float: left; margin: -20px 0 0 25px">
            <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0"
                ...
                <param name="movie" value="../../Swf/DesignCampaign.swf" />
            ...
            <div class="swMain" id="wizard" style="margin-top: 60px">
                <div>
                    ...
                    <telerik:RadWizard ID="RadWizard1" runat="server" Height="320px" BackColor="Transparent" CssClass="marginTop350" DisplayNavigationButtons="false">
                        <WizardSteps>
                            <telerik:RadWizardStep runat="server" Title="&nbsp;&nbsp;&nbsp;&nbsp;Select Campaign" ToolTip="Select the campaign to be managed." CssClass="loginStep">
                                <div style="float:left;position: relative; background-repeat: repeat; height: 400px;">
                                    <div style="margin-top: 100px">
                                        <table style="float: left; margin-top: 40px" >
                                            <tr>
                                                <td>
                                                    <%--onkeyPress="ShowSearchData();"--%>
                                                    <asp:TextBox runat="server" ID="txtSearch" placeholder="Search by Campaign Name" Width="250px" />
                                                </td>
                                                <td>
                                                ...
                                                <td> <div style="width:275px"></div></td>
                                                <td style="width: 30px; height: 30px;cursor: pointer;margin-left:200px" onclick="AddNewCampaign();">
                                                    <img src="../../img/Add.png">
                                                </td>
                                                <td>
                                        ...
                                        <div>
                                            <asp:GridView ID="grdCampaign" runat="server" AutoGenerateColumns="false"
                                                ...
                                                AllowSorting="True" AllowPaging="true" OnPageIndexChanging="grdCampaign_PageIndexChanging" PageSize="10"
                                                ...
                                                OnRowDataBound="grdCampaign_RowDataBound" PagerStyle-BackColor="#ef7c31"
                                                CssClass="Grid" AlternatingRowStyle-CssClass="alt" HeaderStyle-CssClass="FixedHeader"
                                                Width="800px" EmptyDataText="No Campaigns Found.">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Campaign Image" ItemStyle-HorizontalAlign="Center" SortExpression="CampaignID">
                                                        <ItemTemplate>
                                                            <asp:Image ID="imgCampaignName" runat="server" ImageUrl='<%# "~/img/"+Eval("FileName") %>' Width="20px" Height="20px" />
                                                        </ItemTemplate>
                                                        <EditItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Campaign Color" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Left" SortExpression="Color">
                                                        <ItemTemplate>
                                            ...
                                            <%--<telerik:RadGrid ID="grdCampaign" runat="server" AutoGenerateColumns="false" OnNeedDataSource="grdCampaign_NeedDataSource"
                                                OnRowDataBound="grdCampaign_RowDataBound"
                                                OnDataBinding="grdCampaign_DataBinding"
                                                OnUpdateCommand="grdCampaign_UpdateCommand">
                                                <ClientSettings>
                                                ...
                                                <MasterTableView DataKeyNames="CampaignID">
                                                    <Columns>
                                                        <telerik:GridTemplateColumn HeaderText="#">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblSNo" runat="server" Text='<%#Container.DataSetIndex + 1%>' />
                                                            </ItemTemplate>
                                                        </telerik:GridTemplateColumn>
                                                        <telerik:GridBoundColumn DataField="CampaignID" HeaderText="Campaign Id" UniqueName="CampaignID"
                                                            ColumnGroupName="CampaignID" Visible="false" ReadOnly="true">
                                                        </telerik:GridBoundColumn>
                                                        <telerik:GridTemplateColumn HeaderText="Campaign Image" ItemStyle-HorizontalAlign="Center" SortExpression="CampaignID">
                                                            <ItemTemplate>
                                                                <asp:Image ID="imgCampaignName" runat="server" ImageUrl='<%# "~/img/"+Eval("FileName") %>' Width="20px" Height="20px" />
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                                                        ...
                                                        <telerik:GridTemplateColumn HeaderText="Campaign Color" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Left" SortExpression="Color">
                                                            <ItemTemplate>
                                                                <telerik:RadColorPicker RenderMode="Lightweight" ShowIcon="true" ID="rdDefaultColor" runat="server"
                                                                    PaletteModes="All"
                                                                    OnClientLoad="TelerikDemo.OnClientLoad">
                                                                </telerik:RadColorPicker>
                                                            ...
                                                            <EditItemTemplate>
                                                                <telerik:RadColorPicker RenderMode="Lightweight" ShowIcon="true" ID="RadColorPicker2" runat="server" PaletteModes="All"
                                                                    OnClientLoad="TelerikDemo.OnClientLoad">
                                                                </telerik:RadColorPicker>
                                                            </EditItemTemplate>
                                                        </telerik:GridTemplateColumn>
                                                        <telerik:GridTemplateColumn HeaderText="Campaign Name" SortExpression="CampaignName" FilterControlWidth="200px">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblCampaignName" runat="server" Text='<%#Eval("CampaignName") %>' />
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                                                        ...
                                                        <telerik:GridBoundColumn ItemStyle-HorizontalAlign="Center" FilterControlWidth="145px" DataField="DateCreated" HeaderText="Date Created" SortExpression="DateCreated" DataFormatString="{0: dd-MMM-yy}" HtmlEncode="false" ReadOnly="true"></telerik:GridBoundColumn>
                                                        <telerik:GridBoundColumn ItemStyle-HorizontalAlign="Center" FilterControlWidth="145px" DataField="DateModified" HeaderText="Date Modified" SortExpression="DateModified" DataFormatString="{0: dd-MMM-yy}" HtmlEncode="false" ReadOnly="true"></telerik:GridBoundColumn>
                                                    </Columns>
                                                </MasterTableView>
                                            </telerik:RadGrid>--%>
                            ...
                            <telerik:RadWizardStep runat="server" Title="&nbsp;&nbsp;&nbsp;&nbsp;Manage Campaign" ToolTip="Associate playlists to the campaign." CssClass="loginStep">
                                <div style="float: left; position: relative; background-repeat: repeat; height: 600px; margin-top: 30px">
                                    <asp:HiddenField ID="hdnCampaignID" runat="server" />
                                    <table>
                                        <tr>
                                            <td>
                                                <div id="dragdrop" runat="server" style="margin-top: 75px">
                                                    <div style="padding-bottom: 15px">
                                                        <asp:Label ID="lblNote" runat="server" Text="* Please select a playlist and drag & drop to assign playlists to a campaign." CssClass="label" />
                                                    </div>
                                                    <div style="float: left; width: 45%; height: 330px; padding: 10px; margin-right: 25px; background-color: #cbcbcb; border: 2px solid #ef7c31 !important;">
                                                        <h3 class="h3" style="width: 360px; background-color: #ef7c31; text-align: center; margin-left: -5px">Associated Playlists</h3>
                                                        <div class="content scrollbar" style="margin-bottom: 20px; min-height: 300px;">
                                                            ...
                                                            <asp:GridView ID="gvDest" GridLines="Both" Visible="true" runat="server" ShowHeaderWhenEmpty="true" CssClass="Grid drag_drop_grid" AutoGenerateColumns="false"
                                                                DataKeyNames="PlayListName,PlayListID" AlternatingRowStyle-CssClass="alt" PagerStyle-CssClass="pgr" HeaderStyle-CssClass="FixedHeader"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField>
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:Panel ID="pnlMedia" runat="server" Visible="false" Style="position: relative">
                                                                                <asp:GridView ID="gvMedia" runat="server" AutoGenerateColumns="false" PageSize="5" ShowHeaderWhenEmpty="true"
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Icon" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Left">
                                                                        <ItemTemplate>
                                                                            <asp:Image ID="imgThumbNail" runat="server" ImageUrl='<%# "~/img/" + Eval("FileName") %>' CssClass="thumbNailImage" />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:HyperLinkField runat="server" ItemStyle-Width="220px" DataTextField="PlayListName" HeaderText="Playlist Name"
                                                    ...
                                                    <div style="float: right; min-height: 320px; padding: 10px; width: 45%; background-color: #cbcbcb; border: 2px solid #ef7c31 !important;">
                                                        <h3 class="h3" style="width: 360px; background-color: #ef7c31; text-align: center; margin-left: -5px">Available Playlists</h3>
                                                        <div class="content scrollbar" style="min-height: 300px;">
                                                            <asp:GridView ID="gvSource" GridLines="Both" runat="server" CssClass="Grid drag_drop_grid" AutoGenerateColumns="false"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Icon" ItemStyle-Width="30px" ItemStyle-HorizontalAlign="Left">
                                                                        <ItemTemplate>
                                                                            <asp:Image ID="imgThumbNail" runat="server" ImageUrl='<%# "~/img/" + Eval("FileName") %>' CssClass="thumbNailImage" />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField ItemStyle-Width="220px" ItemStyle-HorizontalAlign="Left" DataField="PlayListName"
                                                                        HeaderText="Playlist Name" HeaderStyle-HorizontalAlign="Left" SortExpression="PlayListName"></asp:BoundField>
                                                                </Columns>
                                                            </asp:GridView>
                                                        </div>
                                                    </div>
        ...
        <%-- <div style="float: left; width: 35%;margin-top:-68px">
            <asp:ImageButton ImageUrl="~/img/RADCycle_DesignCampaign.gif" runat="server" Width="325px" Height="325px" 
                CssClass="siteMapImage" PostBackUrl="~/Default.aspx" />
        </div>--%>
    </div>
    <div id="footer">
    ...
    <telerik:RadWindowManager RenderMode="Lightweight" ID="RadWindowManager1" runat="server" EnableShadow="true">
        <Windows>
            <telerik:RadWindow RenderMode="Lightweight" ID="RadCampaignDialog" runat="server" Height="320px"
