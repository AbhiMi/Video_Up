<%@ Page Title="" Language="C#" MasterPageFile="~/RADVupTiles.master" AutoEventWireup="true" CodeFile="CreateCompany.aspx.cs" Inherits="Pages_CreateCompany" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            function AddNewCompany() {
                window.radopen("AddNewCompany.aspx", "RadCompanyDialog");
                return false;
            }
        </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
            ...
            <div class="swMain" id="wizard" style="margin-top: 60px">
                <div>
                    ...
                    <telerik:RadWizard ID="RadWizard1" runat="server" Height="320px" BackColor="Transparent" CssClass="marginTop350" DisplayNavigationButtons="false">
                        <WizardSteps>
                            <telerik:RadWizardStep runat="server" Title="&nbsp;&nbsp;&nbsp;&nbsp;Create Company" ToolTip="Create the company." CssClass="loginStep">
                                    ...
                                    <div style="margin-top: 100px">
                                        <table style="float: left; margin-top: 40px" >
                                            <tr>
                                                <td>
                                                    ...
                                                    <asp:TextBox runat="server" ID="txtSearch" placeholder="Search by Company Name" Width="250px" />
                                                </td>
                                                <td>
                                                ...
                                                <td style="width: 30px; height: 30px;cursor: pointer;margin-left:200px" onclick="AddNewCompany();">
                                                    <img src="../../img/Add.png">
                                                </td>
                                                <td>
                                        ...
                                        <div>
                                            <asp:GridView ID="grdCompany" runat="server" AutoGenerateColumns="false"
                                                ...
                                                AllowSorting="True" AllowPaging="true" OnPageIndexChanging="grdCompany_PageIndexChanging" PageSize="10"
                                                ...
                                                OnRowDataBound="grdCompany_RowDataBound" PagerStyle-BackColor="#ef7c31"
                                                CssClass="Grid" AlternatingRowStyle-CssClass="alt" HeaderStyle-CssClass="FixedHeader"
                                                Width="800px" EmptyDataText="No Companies Found.">
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="#" ItemStyle-Width="25px" ItemStyle-HorizontalAlign="Center" SortExpression="CompanyID">
                                                        <ItemTemplate>
                                                            <span>
                                                    ...
                                                    <asp:TemplateField HeaderText="Company Name" SortExpression="CompanyName">
                                                        ...
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txtCompanyName" Width="170px" runat="server" Text='<%#Eval("CompanyName") %>' />
                                                        </EditItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Company Code" SortExpression="CompanyCode">
                                                        ...
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txtCompanyCode" Width="170px" runat="server" Text='<%#Eval("CompanyCode") %>' />
                                                        </EditItemTemplate>
                                                    </asp:TemplateField>
    ...
    <telerik:RadWindowManager RenderMode="Lightweight" ID="RadWindowManager1" runat="server" EnableShadow="true">
        <Windows>
            <telerik:RadWindow RenderMode="Lightweight" ID="RadCompanyDialog" runat="server" Height="320px"
