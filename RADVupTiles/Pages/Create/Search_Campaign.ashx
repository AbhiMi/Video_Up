<%@ WebHandler Language="C#" Class="Search_Campaign" %>
...
/// </summary>
public class Search_Campaign : IHttpHandler
{
    public void ProcessRequest(HttpContext context)
    {
        ...
        {
            using (SqlCommand objSqlcmd = new SqlCommand("SP_GetCampaignName", objSqlConn))
            {
