<%@ WebHandler Language="C#" Class="Search_Playlist" %>
...
/// <summary>
/// Summary description for Search_Playlist
/// </summary>
public class Search_Playlist : IHttpHandler
{
    public void ProcessRequest(HttpContext context)
    {
        ...
        {
            using (SqlCommand objSqlcmd = new SqlCommand("SP_GetPlaylistName", objSqlConn))
            {
