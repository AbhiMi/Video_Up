<%@ WebHandler Language="C#" Class="Search_Media" %>
...
/// </summary>
public class Search_Media : IHttpHandler
{
    public void ProcessRequest(HttpContext context)
    {
        ...
        {
            using (SqlCommand objSqlcmd = new SqlCommand("SP_SearchMedia", objSqlConn))
            {
