...
// It takes the currentUser (defined in the VideoUpTile.master), the UI config (as above)
// and the TileBuilders that comes from Tiles.js.
var viewModel = new DashboardModel("Bed Bath & Beyond", [], window.currentUser, ui);
